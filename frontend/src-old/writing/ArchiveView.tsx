...
export default function ArchiveView() {
  ...
  const handleRestore = async (id: number) => {
    try {
      ...
      toast.success('Idea restored to in progress');
      refetch();
    } catch (error) {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await invoke('delete_idea', { id: deleteDialog.ideaId });
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to permanently delete this idea? This action cannot be undone and the idea cannot be restored."
